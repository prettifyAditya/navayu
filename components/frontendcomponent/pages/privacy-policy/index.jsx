export default function PrivacyPolicyPage() {
  return (
    <section>
      <div className="privacy-secA mt-hdrfix sec-pad-all">
        <div className="container">
          <div className="website-content">
            <h1>Privacy Policy</h1>
            <h3>Introduction</h3>
            <p>
              When you interact with Navayu, we may collect the following types
            ...
            <ul>
              ...
              <li>
                <b>Demographic Information:</b> Age, gender, and other
                demographic details.
              </li>
              <li>
                <b>Communication Information:</b> Messages, feedback, and
                inquiries.
              </li>
            </ul>
            ...
            <ul>
              <li>
                <b>Usage Data:</b> Information about how you use our website,
                including the pages you visit, the time spent on those pages,
            ...
            <p>
              Navayu uses the collected information for various purposes,
              including:
            </p>
            <ul>
              <li>To provide, operate, and maintain our services.</li>
              <li>
                To process and manage donations and volunteering applications.
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                other parties if you have given us explicit permission to do so.
              </li>
            </ul>
            ...
            <p>
              ...
              by posting the new policy on our website and updating the
